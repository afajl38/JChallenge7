...
var ES = require('es-abstract').ES2020;
...
require('es-abstract/test/tests').es2020(boundES, ops, expectedMissing);

require('es-abstract/test/helpers/runManifestTest')(require('tape'), ES, 2020);
