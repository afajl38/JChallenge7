...
var stylize = require('vows/lib/vows/console').stylize;
var console = vows.console = require('vows/lib/vows/console');

vows.inspect = require('vows/lib/vows/console').inspect;
vows.prepare = require('vows/lib/vows/extras').prepare;
vows.tryEnd  = require('vows/lib/vows/suite').tryEnd;

//
// Assertion Macros & Extensions
//
require('vows/lib/assert/error');
require('vows/lib/assert/macros');

//
// Suite constructor
//
var Suite = require('vows/lib/vows/suite').Suite;
